...
const TONE_CONFIG: Record<Tone, { border: string; text: string; glow: string; Icon: IconType }> = {
  blue:   { border: 'border-accent-blue/60',   text: 'text-accent-blue',   glow: 'hover:shadow-glow-blue',   Icon: GiWorld        },
  amber:  { border: 'border-accent-amber/60',  text: 'text-accent-amber',  glow: 'hover:shadow-glow-amber',  Icon: GiFlagObjective },
  green:  { border: 'border-accent-green/60',  text: 'text-accent-green',  glow: 'hover:shadow-glow-green',  Icon: GiModernCity   },
  purple: { border: 'border-accent-purple/60', text: 'text-accent-purple', glow: 'hover:shadow-glow-purple', Icon: GiEyeTarget    },
};
...
export function KpiCard({
  ...
  return (
    <div className={`rounded-2xl bg-bg-surface border ${border} p-4 lg:p-6 transition-shadow duration-300 shadow-card ${glow}`}>
